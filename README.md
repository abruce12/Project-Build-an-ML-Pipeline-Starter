...
Wandb link:
https://wandb.ai/amtownsend05-western-governors-university/nyc_airbnb/workspace?nw=nwuseramtownsend05
Github link:
https://github.com/abruce12/Project-Build-an-ML-Pipeline-Starter.git
...
```
git clone https://github.com/[abruce12]/Project-Build-an-ML-Pipeline-Starter.git
```
